...
communications, algorithms and planning; Figure :numref:`fig:intro-overview` .


.. This figure is owned by RoboScience


.. _`fig:intro-overview`:
...
agents acting independently to some degree, :numref:`fig:taxonomy`.
...
:numref:`fig:intro-components` shows the basic hardware elements of a typical
...
:numref:`fig:intro-components`. The familiar sensor is the Microsoft Kinect. The
...
- :index:`iRobot Create`, Figure :numref:`fig:irobotcreate`. This robot based on the iRobot Roomba, was introduced
...
- :index:`Parallax` :index:`Boe Bot`, Figure :numref:`fig:boebot`. Parallax has been in the educational
